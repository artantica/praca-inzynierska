...
class _GuiSession():  # pylint:disable=too-few-public-methods
    ...
    def _check_valid_choices(self):
        ...
        no longer valid and remove them so that they are not passed into faceswap_original. """
...
class Tasks(_GuiSession):
    ...
    def save(self, save_as=False):
        """ Save the current GUI state for the active tab to a ``.fst`` faceswap_original task file.
