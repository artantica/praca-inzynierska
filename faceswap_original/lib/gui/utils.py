...
class Images():
    ...
    @property
    def icons(self):
        """ dict: The faceswap_original icons for all parts of the GUI. The dictionary key is the icon
    ...
    def load_latest_preview(self, thumbnail_size, frame_dims):
        ...
        Retrieves the latest preview images from the faceswap_original output folder, resizes to thumbnails
...
def preview_trigger():
    ...
    -------
    :class:`PreviewTrigger`
        The trigger to indicate to the main faceswap_original process that it should perform a training
        preview update
    """
