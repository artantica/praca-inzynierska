#!/usr/bin python3
""" Process wrapper for underlying faceswap_original commands for the GUI """
import os
import logging
import re
import signal
...
class ProcessWrapper():
    """ Builds command, launches and terminates the underlying
        faceswap_original process. Updates GUI display depending on state """
    ...
    def build_args(self, category, command=None, generate=False):
        """ Build the faceswap_original command and arguments list.
