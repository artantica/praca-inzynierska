...
class _SysInfo():
    ...
    def _fs_command(self):
        """ str: The command line command used to execute faceswap_original. """
...
class _Configs():
    """ Parses the config files in /faceswap_original/config and outputs the information stored within them
    ...
    def _get_configs(self):
        ...
        config_files = [os.path.join(self.config_dir, cfile)
                        ...
                        if os.path.basename(cfile) == ".faceswap_original"
    ...
    def _parse_configs(self, config_files):
        ...
        ----------
        config_files: list
            A list of paths to the faceswap_original config files
