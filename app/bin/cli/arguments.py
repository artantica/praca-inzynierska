...
from app.lib.utils import get_backend
from app.lib.gpu_stats import GPUStats
...
class ConvertLiveArgs(FaceSwapArgs):
    """ Creates the command line arguments for live conversion. """

    @staticmethod
    def get_info():
        """ The information text for the ConvertLive command.
        ...
        str
            The information text for the ConvertLive command.
        """
        return ("Swap the original faces in a live video to your final faces.\n"
                "Model plugins can be configured in the 'Settings' Menu")

    @staticmethod
    def get_argument_list():
        """ Returns the argument list for ConvertLive arguments.

        Returns
        -------
        list
            The list of command line options for live convertion
        """
